...
?>
            ...
            <ul class="nav nav-tabs nav-stacked" style="background: whitesmoke;">
                ...
                <li class="<?php if(isset($_GET['dashboard'])){ echo "active"; } ?>">
                    ...
                    <a href="manager.php?dashboard&lang=eng"> <i class="fa fa-fw fa-dashboard"> </i> Dashboard </a>
                ...
                <li class="<?php if(isset($_GET['user_report'])||isset($_GET['reg_report'])){ echo "active"; } ?>">
                    ...
                    <ul id="reports" class="collapse nav nav-tabs  nav-stacked">
                        ...
                        <li>
                            <a href="manager.php?user_report&lang=eng"> User report </a>
                        </li>

                        <li>
                            <a href="manager.php?reg_report&lang=eng"> Main report </a>
                        </li>
                ...
                <li class="<?php if(isset($_GET['manager_stat'])){ echo "active"; } ?>">
                    ...
                    <a href="manager.php?manager_stat&lang=eng"><i class="fa fa-fw fa-bar-chart"></i> Statistics </a>
                ...
                <li>
                    ...
                    <ul id="users" class="collapse nav nav-tabs  nav-stacked">
                        ...
                        <li>
                            <a href="manager.php?insert_user&lang=eng"> Insert User </a>
                        </li>

                        <li>
                            <a href="manager.php?view_users&lang=eng"> View Users </a>
                        </li>

                        <li>
                            <a href="manager.php?user_profile=<?php echo $user_id; ?>&lang=eng"> Edit Profile </a>
                        </li>
